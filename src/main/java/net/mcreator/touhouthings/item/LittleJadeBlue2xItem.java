...
public class LittleJadeBlue2xItem extends Item {
	public LittleJadeBlue2xItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u7ECF\u5178\u7684\u7EA2\u8272\u5B50\u5F39"));
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					LittleJadeBlue2xEntity entityarrow = LittleJadeBlue2xEntity.shoot(world, entity, world.getRandom(), 2f, 2, 0);
