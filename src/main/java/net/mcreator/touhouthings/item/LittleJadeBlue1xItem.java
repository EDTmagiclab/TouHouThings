...
public class LittleJadeBlue1xItem extends Item {
	public LittleJadeBlue1xItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u7ECF\u5178\u7684\u84DD\u8272\u5B50\u5F39"));
		list.add(Component.literal("\u5F39\u901F1x"));
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					LittleJadeBlue1xEntity entityarrow = LittleJadeBlue1xEntity.shoot(world, entity, world.getRandom(), 1f, 2, 0);
