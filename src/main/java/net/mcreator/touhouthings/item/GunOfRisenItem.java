...
public class GunOfRisenItem extends Item {
	public GunOfRisenItem() {
		super(new Item.Properties().tab(TouhouthingsModTabs.TAB_TOUHOU_THINGS).durability(350));
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u94C3\u4ED9\u7684\u540C\u6B3E\u6B66\u5668"));
		list.add(Component.literal("\u547D\u4E2D\u540E\u4F1A\u5BF9\u654C\u4EBA\u7684\u7CBE\u795E\u4EA7\u751F\u5F71\u54CD"));
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					GunOfRisenEntity entityarrow = GunOfRisenEntity.shoot(world, entity, world.getRandom(), 1f, 4, 3);
