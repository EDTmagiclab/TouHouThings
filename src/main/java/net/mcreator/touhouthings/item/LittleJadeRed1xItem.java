...
public class LittleJadeRed1xItem extends Item {
	public LittleJadeRed1xItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					LittleJadeRed1xEntity entityarrow = LittleJadeRed1xEntity.shoot(world, entity, world.getRandom(), 1f, 2, 0);
