...
public class BigJadeBlue1xItem extends Item {
	public BigJadeBlue1xItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					BigJadeBlue1xEntity entityarrow = BigJadeBlue1xEntity.shoot(world, entity, world.getRandom(), 1f, 3, 0);
