...
public class BigJadeBlue2xItem extends Item {
	public BigJadeBlue2xItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u8F83\u5927\u7684\u7389"));
		list.add(Component.literal("\u5F39\u901F2x"));
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					BigJadeBlue2xEntity entityarrow = BigJadeBlue2xEntity.shoot(world, entity, world.getRandom(), 2f, 3, 0);
