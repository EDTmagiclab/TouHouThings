...
public class LittleJadeRed2xItem extends Item {
	public LittleJadeRed2xItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					LittleJadeRed2xEntity entityarrow = LittleJadeRed2xEntity.shoot(world, entity, world.getRandom(), 2f, 2, 0);
