...
public class BigJadeRed1xItem extends Item {
	public BigJadeRed1xItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					BigJadeRed1xEntity entityarrow = BigJadeRed1xEntity.shoot(world, entity, world.getRandom(), 1f, 3, 0);
