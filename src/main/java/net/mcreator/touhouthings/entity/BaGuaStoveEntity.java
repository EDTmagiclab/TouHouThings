...
public class BaGuaStoveEntity extends AbstractArrow implements ItemSupplier {
	public BaGuaStoveEntity(EntityType<? extends BaGuaStoveEntity> type, Level world) {
		super(type, world);
	}

	public BaGuaStoveEntity(EntityType<? extends BaGuaStoveEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public BaGuaStoveEntity(EntityType<? extends BaGuaStoveEntity> type, LivingEntity entity, Level world) {
	...
	public static BaGuaStoveEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
	...
	public static BaGuaStoveEntity shoot(LivingEntity entity, LivingEntity target) {
		BaGuaStoveEntity entityarrow = new BaGuaStoveEntity(TouhouthingsModEntities.BA_GUA_STOVE, entity, entity.level);
